package com.azging.ging.customui;
...
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void setDividerHeightDip(int dipHeight) {
        if (dipHeight >= 0) {
            mHeight = DensityUtils.dp2px(mContext, dipHeight);
        }
    }
    ...
    public void setPaddingLeftDip(int paddingLeftDip){
        this.paddingLeft = DensityUtils.dp2px(mContext, paddingLeftDip);
    }
    ...
    public void setPaddingRightDip(int paddingRightDip) {
        this.paddingRight = DensityUtils.dp2px(mContext, paddingRightDip);
    }
}
