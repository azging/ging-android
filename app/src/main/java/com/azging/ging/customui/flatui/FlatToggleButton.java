...
public class FlatToggleButton extends ToggleButton implements Attributes.AttributeChangeListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        uncheckedEnabledBack.getPaint().setColor(Color.parseColor("#d2d2d2"));
        ...
        uncheckedDisabledBack.getPaint().setColor(Color.parseColor("#d2d2d2"));
        ...
        checkedDisabledBack.getPaint().setColor(Color.parseColor("#d2d2d2"));
