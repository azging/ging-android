...
public class Attributes {
    ...
    public static int DEFAULT_THEME = R.array.orange_array;
    ...
    public static int DEFAULT_SIZE_PX = 24;
    ...
    public void setThemeSilent(int theme, Resources resources) {
        try {
            ...
            colors = new int[]{Color.parseColor("#ffe100"), Color.parseColor("#ffe100"),
                    Color.parseColor("#ffffff"), Color.parseColor("#ffe100")};
        }
    }
